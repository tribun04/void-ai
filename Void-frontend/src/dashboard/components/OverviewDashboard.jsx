...
export function OverviewDashboard({ setActiveView }) {
    ...
    useEffect(() => {
        const fetchAllData = async () => {
            ...
            setStats({
                users: usersRes.status === 'fulfilled' ? usersRes.value.data.length : 'N/A',
                newToday: newTodayRes.status === 'fulfilled' ? newTodayRes.value.data.count : 'N/A',
                intents: intentsRes.status === 'fulfilled' ? intentsRes.value.data.length : 'N/A'
            });
